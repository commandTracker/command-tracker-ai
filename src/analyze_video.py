...
def analyze_video():
    video_path = os.path.join(os.path.dirname(os.getcwd()), "temp_video", "test.mp4")
    ...
    results = model.track(project="../detect", name="result", source=video_path, tracker="botsort.yaml", save=True, imgsz=320, vid_stride=2, stream=True)
